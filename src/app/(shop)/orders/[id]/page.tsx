...
export default function OrderIdPage({params}: Props) {
  const {id} = params
  return (
    <div className="flex justify-center items-center mb-14 px-10 sm:px-0">
      <div className="flex flex-col container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
          ...
          <div className="bg-white rounded-xl shadow-xl p-7">
            ...
            <div className="flex items-center rounded-lg py-2 px-3.5 text-xs font-bold text-white mb-5 bg-green-700 mt-5">
              <IoCardOutline size={30} />
              <span className="mx-2">Pendiente de Pago</span>  
            </div>
